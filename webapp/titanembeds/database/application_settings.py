...
class ApplicationSettings(db.Model):
    ...
    # Current progress towards donation goal
    donation_goal_progress = db.Column(db.Integer, nullable=False, server_default="0")
    # Total donation required to hit goal. 0 to now show banners
    donation_goal_total = db.Column(db.Integer, nullable=False, server_default="0")
